<p align="center">
  ...
  <p align="center">
    Современная панель запуска приложений на основе плиток, вдохновленная Windows 8.<br>
    Перетаскиваемая сетка, обложки SteamGridDB, глобальные горячие клавиши, полная локализация.
  </p>
</p>
...
#  [Видео на YouTube](https://www.youtube.com/watch?v=Ib7YLjwEdE8) 
